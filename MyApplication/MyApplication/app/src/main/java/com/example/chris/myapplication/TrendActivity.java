...
public class TrendActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    DrawerLayout drawerLayout;
    NavigationView navigationView;
    Toolbar toolbar;
    String TAG = "TrendActivity";
...
//            navigationView.setCheckedItem(R.id.setting_frag);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.COMPANY:
                ...
                changeActivity = new Intent(TrendActivity.this, CompanyActivity.class);
            ...
            case R.id.RECEIPT:
                changeActivity = new Intent(TrendActivity.this, ReceiptActivity.class);
            ...
            case R.id.PRODUCT:
                changeActivity = new Intent(TrendActivity.this, ProductActivity.class);
            ...
            case R.id.OFFER:
                changeActivity = new Intent(TrendActivity.this, OfferActivity.class);
            ...
            case R.id.TREND:
                changeActivity = new Intent(TrendActivity.this, TrendActivity.class);
    ...
    public void ImageHttpRequest(String requestURL,String PData) {
        ...
        if (checkPermissionWRITE_EXTERNAL_STORAGE(TrendActivity.this)) {

            ByteArrayOutputStream bytes = new ByteArrayOutputStream();
            FixBitmap.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
            file = MediaStore.Images.Media.insertImage(TrendActivity.this.getContentResolver(), FixBitmap, "Title", null);
        }

        Intent changeActivity = new Intent(TrendActivity.this, CornerActivity.class);
