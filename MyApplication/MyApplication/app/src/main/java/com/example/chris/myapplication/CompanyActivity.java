...
//            navigationView.setCheckedItem(R.id.setting_frag);
    ...
    public void UploadImageToServer(){
        ...
        public void ImageHttpRequest(String requestURL,String PData) {
            ...
            if (checkPermissionWRITE_EXTERNAL_STORAGE(CompanyActivity.this)) {

                ByteArrayOutputStream bytes = new ByteArrayOutputStream();
                FixBitmap.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
                file = MediaStore.Images.Media.insertImage(CompanyActivity.this.getContentResolver(), FixBitmap, "Title", null);
            }

            Intent changeActivity = new Intent(CompanyActivity.this, CornerActivity.class);
