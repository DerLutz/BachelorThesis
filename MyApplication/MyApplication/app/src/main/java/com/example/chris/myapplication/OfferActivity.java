...
//            navigationView.setCheckedItem(R.id.setting_frag);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.COMPANY:
                ...
                changeActivity = new Intent(OfferActivity.this, CompanyActivity.class);
            ...
            case R.id.RECEIPT:
                changeActivity = new Intent(OfferActivity.this, ReceiptActivity.class);
            ...
            case R.id.PRODUCT:
                changeActivity = new Intent(OfferActivity.this, ProductActivity.class);
            ...
            case R.id.OFFER:
                changeActivity = new Intent(OfferActivity.this, OfferActivity.class);
            ...
            case R.id.TREND:
                changeActivity = new Intent(OfferActivity.this, TrendActivity.class);
    ...
    public void ImageHttpRequest(String requestURL,String PData) {
        ...
        if (checkPermissionWRITE_EXTERNAL_STORAGE(OfferActivity.this)) {

            ByteArrayOutputStream bytes = new ByteArrayOutputStream();
            FixBitmap.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
            file = MediaStore.Images.Media.insertImage(OfferActivity.this.getContentResolver(), FixBitmap, "Title", null);
        }

        Intent changeActivity = new Intent(OfferActivity.this, CornerActivity.class);
