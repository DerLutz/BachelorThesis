...
//            navigationView.setCheckedItem(R.id.setting_frag);
    ...
    public void ImageHttpRequest(String requestURL,String PData) {
        ...
        if (checkPermissionWRITE_EXTERNAL_STORAGE(ReceiptActivity.this)) {

            ByteArrayOutputStream bytes = new ByteArrayOutputStream();
            FixBitmap.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
            file = MediaStore.Images.Media.insertImage(ReceiptActivity.this.getContentResolver(), FixBitmap, "Title", null);
        }

        Intent changeActivity = new Intent(ReceiptActivity.this, CornerActivity.class);
