...
public class ReceiptRecView extends RecyclerView.Adapter<ReceiptRecView.NumberViewHolder> {
    ...
    private static final String TAG = ReceiptRecView.class.getSimpleName();
         ...
         */
        public ReceiptRecView(int numberOfItems, ListItemClickListener listener) {
        ...
        class NumberViewHolder extends RecyclerView.ViewHolder
             ...
             *                 {@link ReceiptRecView#onCreateViewHolder(ViewGroup, int)}
             */
             ...
             */
            //TODO (Rename Receipt 1 etc. to ???)
            void bind(int listIndex) {
                //listItemNumberView.setText(String.valueOf(listIndex));
                listItemNumberView.setText("Receipt " + listIndex);
            }
