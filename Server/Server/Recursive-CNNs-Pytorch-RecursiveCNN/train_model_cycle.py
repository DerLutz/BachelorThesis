...
parser.add_argument('--epochs', type=int, default=5, help='Number of epochs for trianing')
...
parser.add_argument("-i", "--data-dirs", nargs='+', default="/home/queling/BachelorThesis/selfCollectedData_DocCyclic/",
                    help="input Directory of train data")
parser.add_argument("-v", "--validation-dirs", nargs='+', default="/home/queling/BachelorThesis/selfCollectedData_DocCyclic/",
