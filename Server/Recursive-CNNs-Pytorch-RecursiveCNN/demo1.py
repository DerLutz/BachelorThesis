...
if __name__ == '__main__':
	app.run(host='192.168.188.63',port=1337, debug=False, threaded=True) #True shows all Errors (for develop), later change to False, threaded=True for multithreating
