...
parser.add_argument('--name', default="corner",
                    help='Name of the experiment')
parser.add_argument('--output-dir', default="/home/queling/BachelorThesis/",
...
parser.add_argument('--dataset', default="corner", help='Dataset to be used; example document, corner')
...
parser.add_argument("-i", "--data-dirs", nargs='+', default="/home/queling/BachelorThesis/selfCollectedData_CornDetec",
                    help="input Directory of train data")
parser.add_argument("-v", "--validation-dirs", nargs='+', default="/home/queling/BachelorThesis/selfCollectedData_CornDetec",
