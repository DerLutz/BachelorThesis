...
def args_processor():
    ...
    parser.add_argument("-i", "--imagePath", default="/home/christopher/Documents/ResultsTraining/TestImage1.jpg", help="Path to the document image")
    ...
    parser.add_argument("-cm", "--cornerModel", help="Model for corner point refinement",
                        default="../CornerTraining/namecorner_resnet.pb")
    parser.add_argument("-dm", "--documentModel", help="Model for document corners detection",
                        default="../DocumentTraining/nonamedocument_resnet.pb")
...
if __name__ == "__main__":
    ...
    print(corner_address) #cv2.imwrite(args.outputPath, oImg)
